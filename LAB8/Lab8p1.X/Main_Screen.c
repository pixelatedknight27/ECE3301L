...
void update_LCD_misc() {
    ...
    if (Light_Sensor == 0) Light_Sensor_Mode_Txt[1] = 'N';
    else Light_Sensor_Mode_Txt[1] = 'D';
    if (MODE == 0) Act_Mode_Txt[0] = 'N';
    else Act_Mode_Txt[0] = 'D';
    ...
    if (SW_NSPED == 0) SW_NSPED_Txt[0] = '0';
    else SW_NSPED_Txt[0] = '1';
    if (SW_NSLT == 0) SW_NSLT_Txt[0] = '0';
    else SW_NSLT_Txt[0] = '1';
    if (SW_EWPED == 0) SW_EWPED_Txt[0] = '0';
    else SW_EWPED_Txt[0] = '1';
    if (SW_EWLT == 0) SW_EWLT_Txt[0] = '0';
